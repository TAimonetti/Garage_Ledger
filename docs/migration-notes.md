...
- Run `scripts/run-sample-fixture-regression.ps1` to verify the supplied sample files directly, or pass `-Dguzzlio.fixture.abp=<path>` and `-Dguzzlio.fixture.csv=<path>` to `testDebugUnitTest` on another machine.
