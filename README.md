...
Guzzlio is a local-first Android replacement for the old aCar/Fuelly mobile workflow. This repo is focused on offline durability, faithful import of historical data, a dense dashboard-first console, and open export formats.
...
- [`app/src/main/kotlin/com/guzzlio/data`](D:/Code/Codex/Guzzlio/app/src/main/kotlin/com/guzzlio/data): importers, repository, Room persistence, and export orchestration
- [`app/src/main/kotlin/com/guzzlio/background`](D:/Code/Codex/Guzzlio/app/src/main/kotlin/com/guzzlio/background): WorkManager scheduling and workers
- [`app/src/main/kotlin/com/guzzlio/attachments`](D:/Code/Codex/Guzzlio/app/src/main/kotlin/com/guzzlio/attachments): local attachment import/capture storage
- [`app/src/main/kotlin/com/guzzlio/domain`](D:/Code/Codex/Guzzlio/app/src/main/kotlin/com/guzzlio/domain): pure models and calculation rules
- [`app/src/main/kotlin/com/guzzlio/notifications`](D:/Code/Codex/Guzzlio/app/src/main/kotlin/com/guzzlio/notifications): notification channel and reminder notifier
- [`app/src/main/kotlin/com/guzzlio/shortcuts`](D:/Code/Codex/Guzzlio/app/src/main/kotlin/com/guzzlio/shortcuts): launcher quick actions and pinning helpers
- [`app/src/main/kotlin/com/guzzlio/widgets`](D:/Code/Codex/Guzzlio/app/src/main/kotlin/com/guzzlio/widgets): app widget providers, updater, and reminder formatting
- [`app/src/main/kotlin/com/guzzlio/ui`](D:/Code/Codex/Guzzlio/app/src/main/kotlin/com/guzzlio/ui): Compose dashboard, settings, type management, statistics/charts, record detail, import center, browse screen, vehicle detail, and record editors
- [`docs/architecture.md`](D:/Code/Codex/Guzzlio/docs/architecture.md): implementation plan and schema proposal
- [`docs/import-formats.md`](D:/Code/Codex/Guzzlio/docs/import-formats.md): CSV/ABP/Fuelly format notes
- [`docs/migration-notes.md`](D:/Code/Codex/Guzzlio/docs/migration-notes.md): migration assumptions and sample expectations
- [`docs/known-differences-vs-acar.md`](D:/Code/Codex/Guzzlio/docs/known-differences-vs-acar.md): honest deltas from aCar today
- [`docs/release-checklist.md`](D:/Code/Codex/Guzzlio/docs/release-checklist.md): final automated and device QA pass
