...
interface GarageDao {
    ...
    suspend fun getRecordAttachments(recordFamily: com.guzzlio.domain.model.RecordFamily, recordId: Long): List<RecordAttachmentEntity>
    ...
    suspend fun deleteRecordAttachmentsForRecord(recordFamily: com.guzzlio.domain.model.RecordFamily, recordId: Long)
