...
fun RecordDetailScreen(
    ...
    val serviceTypes by produceState(initialValue = emptyList<com.guzzlio.domain.model.ServiceType>(), key1 = family, key2 = refreshSignal) {
        value = if (family == RecordFamily.SERVICE) repository.getServiceTypes() else emptyList()
    }
    val expenseTypes by produceState(initialValue = emptyList<com.guzzlio.domain.model.ExpenseType>(), key1 = family, key2 = refreshSignal) {
        value = if (family == RecordFamily.EXPENSE) repository.getExpenseTypes() else emptyList()
    }
    val tripTypes by produceState(initialValue = emptyList<com.guzzlio.domain.model.TripType>(), key1 = family, key2 = refreshSignal) {
...
private fun FuelUpDetailContent(
    fillUp: FillUpRecord,
    preferences: com.guzzlio.domain.model.AppPreferenceSnapshot,
