...
fun ServiceEditorScreen(
    ...
    val showServiceCenter = com.guzzlio.domain.model.OptionalFieldToggle.SERVICE_CENTER in visibleFields
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                CompactFormSectionHeader("Service Types")
            }
            item {
                CompactMultiChoiceSelectionRow(
                    ...
                    extraActionLabel = "Manage Service Types",
                    onExtraAction = onOpenServiceTypes,
                )
            }
            if (showServiceCenter) {
                item { CompactFormSectionHeader("Service Center") }
                item {
                    Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
                        CompactChoiceDialogRow(
                            label = "Center",
