...
class ReminderWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_REFRESH: String = "com.garageledger.widgets.REMINDER_REFRESH"
        ...
        private fun refreshAsync(context: Context, manager: AppWidgetManager, ids: IntArray) {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                val container = (appContext as com.garageledger.GarageLedgerApplication).container
        ...
        private fun buildRemoteViews(
            context: Context,
            appWidgetId: Int,
            reminders: List<com.garageledger.domain.model.ReminderWidgetItem>,
