...
import com.garageledger.GarageLedgerApplication
...
class PredictionWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_REFRESH: String = "com.garageledger.widgets.PREDICTIONS_REFRESH"
        ...
        private fun refreshAsync(context: Context, manager: AppWidgetManager, ids: IntArray) {
            CoroutineScope(Dispatchers.IO).launch {
                val container = (context as GarageLedgerApplication).container
        ...
        private fun buildRemoteViews(
            context: Context,
            appWidgetId: Int,
            item: com.garageledger.domain.model.PredictionWidgetItem?,
