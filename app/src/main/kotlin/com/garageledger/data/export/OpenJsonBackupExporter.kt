...
class OpenJsonBackupExporter(
    ...
    fun export(snapshot: ExportSnapshot, outputStream: OutputStream, exportedAt: LocalDateTime = LocalDateTime.now()) {
        ...
        ZipOutputStream(outputStream.buffered()).use { zip ->
            ...
            zip.putNextEntry(ZipEntry("garage-ledger-backup.json"))
...
internal data class VehiclePayload(
    ...
    companion object {
        fun from(entity: com.garageledger.data.local.VehicleEntity): VehiclePayload = VehiclePayload(
            id = entity.id,
...
internal data class VehiclePartPayload(
    ...
    companion object {
        fun from(entity: com.garageledger.data.local.VehiclePartEntity): VehiclePartPayload = VehiclePartPayload(
            id = entity.id,
            legacySourceId = entity.legacySourceId,
...
internal data class FuelTypePayload(
    ...
    companion object {
        fun from(entity: com.garageledger.data.local.FuelTypeEntity): FuelTypePayload = FuelTypePayload(
            id = entity.id,
            legacySourceId = entity.legacySourceId,
...
internal data class ServiceTypePayload(
    ...
    companion object {
        fun from(entity: com.garageledger.data.local.ServiceTypeEntity): ServiceTypePayload = ServiceTypePayload(
            id = entity.id,
            legacySourceId = entity.legacySourceId,
            name = entity.name,
            notes = entity.notes,
...
internal data class ExpenseTypePayload(
    ...
    companion object {
        fun from(entity: com.garageledger.data.local.ExpenseTypeEntity): ExpenseTypePayload = ExpenseTypePayload(
            id = entity.id,
            legacySourceId = entity.legacySourceId,
            name = entity.name,
            notes = entity.notes,
...
internal data class TripTypePayload(
    ...
    companion object {
        fun from(entity: com.garageledger.data.local.TripTypeEntity): TripTypePayload = TripTypePayload(
            id = entity.id,
            legacySourceId = entity.legacySourceId,
            name = entity.name,
...
internal data class ServiceReminderPayload(
    ...
    companion object {
        fun from(entity: com.garageledger.data.local.ServiceReminderEntity): ServiceReminderPayload = ServiceReminderPayload(
            id = entity.id,
            legacySourceId = entity.legacySourceId,
            vehicleId = entity.vehicleId,
...
internal data class FillUpRecordPayload(
    ...
    companion object {
        fun from(entity: com.garageledger.data.local.FillUpRecordEntity): FillUpRecordPayload = FillUpRecordPayload(
            id = entity.id,
            legacySourceId = entity.legacySourceId,
            vehicleId = entity.vehicleId,
...
internal data class ServiceRecordPayload(
    ...
    companion object {
        fun from(entity: com.garageledger.data.local.ServiceRecordEntity): ServiceRecordPayload = ServiceRecordPayload(
            id = entity.id,
            legacySourceId = entity.legacySourceId,
            vehicleId = entity.vehicleId,
            dateTime = entity.dateTime.format(DateTimeFormatter.ISO_LOCAL_DATE_TIME),
...
internal data class ExpenseRecordPayload(
    ...
    companion object {
        fun from(entity: com.garageledger.data.local.ExpenseRecordEntity): ExpenseRecordPayload = ExpenseRecordPayload(
            id = entity.id,
            legacySourceId = entity.legacySourceId,
            vehicleId = entity.vehicleId,
            dateTime = entity.dateTime.format(DateTimeFormatter.ISO_LOCAL_DATE_TIME),
...
internal data class TripRecordPayload(
    ...
    companion object {
        fun from(entity: com.garageledger.data.local.TripRecordEntity): TripRecordPayload = TripRecordPayload(
            id = entity.id,
            legacySourceId = entity.legacySourceId,
            vehicleId = entity.vehicleId,
...
internal data class AttachmentPayload(
    ...
    companion object {
        fun from(entity: com.garageledger.data.local.RecordAttachmentEntity): AttachmentPayload = AttachmentPayload(
            id = entity.id,
            vehicleId = entity.vehicleId,
